...
export const prospectAuditSchema = z.object({
  Chatbot: z.boolean().describe("Whether the website has a visible Graft AI Agent widget"),
  hasVoiceAgent: z.boolean().describe("Whether the website has any voice/phone AI agent"),
  businessDescription: z.string().describe("1-2 sentence summary of what the business does"),
  coreServices: z
    .array(
      z.object({
  ...
  painPoints: z
    .array(z.string())
    .describe("Implied problems that an AI Graft AI Agent/voice agent could solve for this business"),
