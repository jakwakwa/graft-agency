      ...
      <div className="px-4 sm:px-6 md:px-10 max-w-5xl mx-auto flex flex-col lg:flex-row gap-8 md:gap-16 items-center">
        <div className="lg:w-1/2 space-y-6">
          ...
          <p className="text-on-surface-variant text-lg font-light leading-relaxed">
            GRAFT.TODAY runs on managed cloud hosting securely on every route. Your installed GRAFT Ai Assistant widget loads in an isolated iframe, and every lead, conversation, and setting stays scoped to to your own business.
          </p>
