        ...
        <div className="mb-12 md:mb-16 grid grid-cols-2 gap-8 md:grid-cols-3 lg:gap-20">
          <div className="col-span-2 md:col-span-1">
            ...
            <Typography.P className="max-w-[250px] text-sm leading-relaxed">
              An inbound website assistant that answers visitor enquiries, triaging initiated enquiries with consent,
              and books appointments — so your team can follow up when it matters.
            </Typography.P>
          </div>
            ...
            <Button className="m-0 p-0 w-8 h-8 bg-transparent hover:bg-white/15">
              <Link href={"https://x.com/graft2day"} target="_blank">
                <Image
                  ...
                  width={48}
                  height={48}
                  className="h-8 w-8 p-1 cursor-pointer transition-colors hover:text-white"
                  aria-hidden
                />
              </Link>
            </Button>
