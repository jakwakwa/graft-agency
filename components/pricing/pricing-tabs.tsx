...
export function PricingTabs({ className }: PricingTabsProps) {
  ...
  const tabs = [
    ...
    { id: "website-pricing", label: "Custom Web Builds" },
  ] as const;
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                "relative rounded-full px-6 py-2.5 text-xs md:text-sm font-bold uppercase tracking-wider transition-colors duration-200 cursor-pointer outline-none focus-visible:ring-2 focus-visible:ring-[#9888ff] focus-visible:ring-offset-2 focus-visible:ring-offset-black",
            ...
            >
              {isActive && (
                <motion.div
                  ...
                  className="absolute inset-0 bg-[#9888ff] rounded-full z-[-1] shadow-lg shadow-[#9888ff]/25"
                />
              )}
              {tab.label}
            </button>
