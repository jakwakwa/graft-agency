...
type DropdownMenuItemSelectEvent = Parameters<NonNullable<ComponentProps<typeof DropdownMenuItem>["onSelect"]>>[0];
type PromptInputButtonClickEvent = Parameters<NonNullable<ComponentProps<typeof InputGroupButton>["onClick"]>>[0];
...
export const PromptInputSubmit = ({
  ...
  const handleClick = useCallback(
    (event: PromptInputButtonClickEvent) => {
...
export const PromptInputHoverCardTrigger = ({
  ...
  delay = 0,
  ...props
}: PromptInputHoverCardTriggerProps) => <HoverCardTrigger closeDelay={closeDelay} delay={delay} {...props} />;
