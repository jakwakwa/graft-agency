  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <Typography.Lead className="mt-8">
        ...
        This policy explains what data we collect, why we collect it, how we protect it, and what rights you have as
        a data subject.
      </Typography.Lead>
      ...
      <Section id="about" title="1. About GRAFT.TODAY">
        <Typography.P>
          ...
          Republic of South Africa. We are the &ldquo;responsible party&rdquo; for the personal information of our
          subscribers and website visitors, as defined by the Protection of Personal Information Act 4 of 2013
          (&ldquo;POPIA&rdquo;).
        </Typography.P>
        <Typography.P>
        ...
        <ul className="list-none space-y-1 text-sm text-muted-foreground mt-2">
          ...
          <li>
            <strong className="text-foreground">Physical address:</strong>{" "}
            Parkview Heights, Cape Town, Western Cape, 7550, South Africa
          </li>
        </ul>
      </Section>
      ...
      <Section id="roles" title="2. Our Two Roles — Responsible Party and Operator">
        <Typography.P>
          Because GRAFT.TODAY is a multi-tenant platform, we process personal information in two distinct
          capacities:
        </Typography.P>
        ...
        <div className="mt-3 space-y-3 text-sm">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">
              ...
              (our Merchant of Record). GRAFT.TODAY never stores or has access to your card number, CVV, or full
              payment details.
            </p>
          </div>
          <div>
      ...
      <Section id="operator-data" title="4. Data We Process on Your Behalf (as an Operator)">
        <Typography.P>
          When you use GRAFT.TODAY&rsquo;s products to serve your own customers, we process the following
          categories of data as your operator:
        </Typography.P>
      ...
      <Section id="use" title="5. How We Use Your Personal Information">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground mt-2">
          ...
          <li>
            <strong className="text-foreground">Billing:</strong> Processing your subscription via Paddle,
            handling invoices and renewal events
          </li>
          <li>
            <strong className="text-foreground">Transactional communications:</strong> Sending receipts,
            onboarding guides, important service notices, and alerts (via Resend)
          </li>
          <li>
            <strong className="text-foreground">Security and fraud prevention:</strong> Monitoring for abuse,
            detecting suspicious activity, and maintaining audit logs
          </li>
          <li>
            <strong className="text-foreground">Service improvement:</strong> Analysing aggregated, anonymised
            usage patterns to improve platform performance and features
          </li>
        </ul>
        <Typography.P>
      ...
      <Section id="legal-basis" title="6. Legal Basis for Processing">
        <Typography.P>
          Under POPIA, all processing of personal information must be lawful. The table below sets out the legal
          grounds we rely on:
        </Typography.P>
        <SubTable
      ...
      <Section id="sub-processors" title="7. Sub-Processors and Third-Party Services">
        ...
        <Typography.P>
          ...
          applicable data protection law. We review our sub-processor list regularly and will update this policy
          if it changes.
        </Typography.P>
      </Section>
      ...
      <Section id="retention" title="8. Data Retention">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground mt-2">
          ...
          <li>
            Billing records are retained for up to 7 years to satisfy South African tax and commercial law
            requirements
          </li>
          <li>
            Chatbot conversation logs are retained for the period configured in your dashboard; you may request
            earlier deletion at any time
          </li>
          <li>
            Where we are legally required to retain data for longer, we will do so and inform you if practicable
          </li>
        </ul>
      </Section>
      ...
      <Section id="security" title="9. Security">
        <Typography.P>
          ...
          against unauthorised access, accidental loss, alteration, or destruction. These measures include:
        </Typography.P>
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground mt-2">
        ...
        <Typography.P>
          No method of transmission over the internet or electronic storage is completely secure. If we become
          aware of a data breach that poses a risk to your rights and freedoms, we will notify you and the
      ...
      <Section id="rights" title="10. Your Rights as a Data Subject">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground mt-2">
          ...
          <li>
            <strong className="text-foreground">Right to deletion:</strong> Request deletion or destruction of
            personal information that is no longer lawfully retained
          </li>
          <li>
            <strong className="text-foreground">Right to object:</strong> Object to the processing of your
            personal information on grounds relating to your particular situation
          </li>
          <li>
            <strong className="text-foreground">Right to complain:</strong> Lodge a complaint with the
        ...
        <div className="mt-4 rounded-lg border border-border px-4 py-3 text-sm">
          ...
          <p className="text-muted-foreground">
            If you believe we have handled your personal information unlawfully, you may lodge a formal complaint
            with the Information Regulator at{" "}
            <a
      ...
      <Section id="cookies" title="11. Cookies and Tracking">
        <Typography.P>
          GRAFT.TODAY uses only essential cookies — those strictly necessary for session management and
          authentication. We do not use advertising cookies, third-party tracking pixels, or cross-site tracking
          technology.
        </Typography.P>
        <Typography.P>
          You may configure cookie preferences in your browser settings. Disabling essential cookies will impair
      ...
      <Section id="transfers" title="12. International Data Transfers">
        <Typography.P>
          GRAFT.TODAY serves customers globally. Your personal information may be processed by our sub-processors
          on servers located outside South Africa — primarily in the United States and European Union. In these
          cases, we take reasonable steps to ensure that cross-border transfers are subject to appropriate
          safeguards, consistent with POPIA Section 72.
        </Typography.P>
        <Typography.P>
          By using GRAFT.TODAY, you acknowledge that your personal information may be transferred to and processed
          in jurisdictions outside South Africa.
        </Typography.P>
      </Section>
      ...
      <Section id="direct-marketing" title="13. Electronic Direct Marketing">
        <Typography.P>
          We will only send you marketing communications if you have opted in, or where we have an existing
          business relationship that permits it, in compliance with POPIA Section 69. You may opt out of
          marketing emails at any time by clicking the unsubscribe link in any email or contacting us at{" "}
          <a
            href="mailto:hello@graft.today"
            className="underline underline-offset-4 text-foreground hover:text-muted-foreground"
          >
      ...
      <Section id="changes" title="14. Changes to This Policy">
        <Typography.P>
          ...
          updated&rdquo; date at the top of this page. Where changes are material, we will notify active
          subscribers by email at least 30 days before they take effect. Continued use of GRAFT.TODAY after the
      ...
      <Section id="contact" title="15. Contact Us">
        ...
        <Typography.P>
          <em>
            This policy is a good-faith effort to comply with POPIA and applicable international data protection
            law.
          </em>
        </Typography.P>
      </Section>
