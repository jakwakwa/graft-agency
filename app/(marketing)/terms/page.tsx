    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <Section id="services" title="2. The Services">
        ...
        <ul className="list-disc list-inside space-y-2 text-sm text-muted-foreground mt-2">
          ...
          <li>
            <strong className="text-foreground">Custom website builds:</strong> Design and delivery of websites with the
            GraftBot assistant pre-installed, as described on our pricing page
          </li>
          <li>
