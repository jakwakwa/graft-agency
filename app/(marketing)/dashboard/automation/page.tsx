      ...
      <div className="mb-12">
        <div className="flex items-center justify-between max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center gap-2 group cursor-pointer opacity-50">
            ...
            <span className="text-[10px] font-data uppercase tracking-widest text-muted-foreground">Integration</span>
          </div>
          <div className="flex-1 h-[2px] bg-outline-ghost mx-4" />
          <div className="flex flex-col items-center gap-2 group cursor-pointer opacity-50">
            <div className="w-10 h-10 rounded-full border-2 border-outline-ghost flex items-center justify-center text-muted-foreground font-bold">
            ...
            <span className="text-[10px] font-data uppercase tracking-widest text-muted-foreground">Deployment</span>
          </div>
        </div>
      </div>
          ...
          <Card className="h-full flex flex-col overflow-hidden">
            ...
            <CardContent className="flex-1 p-6 space-y-4 overflow-y-auto max-h-[400px] font-data">
              <div className="flex gap-3 text-[11px] border-l-2 border-primary/40 pl-3 py-1">
                ...
                <span className="text-foreground/80">Agent scraping LinkedIn for high-intent 'FinTech' leads...</span>
              </div>
