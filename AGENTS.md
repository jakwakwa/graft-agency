---
Claude agents: DO NOT READ THIS refer to CLAUDE.md
---
...
This is primarily a TypeScript project. Run type checks/builds after edits and verify against the actual SDK types before claiming a config or migration is correct.
...
---
test failures (do not block PRs)
